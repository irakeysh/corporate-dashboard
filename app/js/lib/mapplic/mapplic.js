...
(function($) {
    ...
    var Mapplic = function() {
        ...
        self.o = {
            ...
            sidebar: true,
            search: true,
            searchaplha: true, // FRT - 2016/03/26
            searchaplhaaddlist: false, // FRT - 2016/03/26
            linkcatalogo: false, // FRT - 2016/03/26
            linkcatalogourl: '', // FRT - 2016/03/26
            deeplinking: true,
            clearbutton: true,
            zoombuttons: true,
            hovertip: true,
        ...
        self.init = function(el, params) {
            ...
            // if (typeof self.o.source === 'string') {
                ...
                $.getJSON(self.o.source + '?nocache=' + (new Date()).getTime(), function(data) { // Success
                    for (var i = 0; i < data.levels[0].locations.length; i++) {
                      data.levels[0].locations[i].title = Math.floor((Math.random() * 143) + 1) + " Employees"
                    }
                    processData(data);
          					// params.source = data;
          					// self.o.source = data;
            ...
            // } else {
				    //     self.o.source.levels[0].locations[2].title = meses[Math.floor(Math.random() * meses.length)];
            //     // Inline json object
        ...
        function Tooltip() {
            ...
            this.init = function() {
                ...
                this.link = $('<a target="_new">Detalhes</a>').addClass('mapplic-tooltip-link').attr('href', '#').hide().appendTo(this.el);
            ...
            this.set = function(location) {
                if (location) {
                    ...
                    //FRT - 2016/03/29
                    if (location.link) {
                        if (self.o.linkcatalogo) {
                            this.link.attr('href', self.o.linkcatalogourl + location.entidadeid).show().addClass("various2").attr('data-fancybox-type', 'iframe');
                        } else {
                    ...
                    //FRT - 2016/03/29
                    if (location.VitrineDestaque == 'True') {
        ...
        function Sidebar() {
            ...
            this.init = function() {
                ...
                if (self.o.search) {
                    ...
                    var input = $('<input>').attr({
                        ...
                        keyword = removeAcentos(keyword);
                        //keyword = "^"+ keyword;
                        s.search(keyword);
                    }).prependTo(form);


                    // FRT - 2016/03/26 - busca por indice
                    if (self.o.searchaplha) {

                        var searchaplha_select = $('<select>').attr({
                                'type': 'text',
                                'spellcheck': 'false',
                                'placeholder': 'Indice'
                            }).addClass('mapplic-search-input-alpha').addClass('alpha')
                        ...
                        if (self.o.searchaplhaaddlist) {
                            var searchaplha_select = $('<ul>').addClass('mapplic-search-list-alpha')
                                .append('<li><a class="busca-indice" href="javascript:pesquisarIndice(\'^A\')">A</a></li>')
                                .append('<li><a class="busca-indice" href="javascript:pesquisarIndice(\'^B\')">B</a></li>')
                                .append('<li><a class="busca-indice" href="javascript:pesquisarIndice(\'^C\')">C</a></li>')
                                .append('<li><a class="busca-indice" href="javascript:pesquisarIndice(\'^D\')">D</a></li>')
                                .append('<li><a class="busca-indice" href="javascript:pesquisarIndice(\'^E\')">E</a></li>')
                                .append('<li><a class="busca-indice" href="javascript:pesquisarIndice(\'^F\')">F</a></li>')
                                .append('<li><a class="busca-indice" href="javascript:pesquisarIndice(\'^G\')">G</a></li>')
                                .append('<li><a class="busca-indice" href="javascript:pesquisarIndice(\'^H\')">H</a></li>')
                                .append('<li><a class="busca-indice" href="javascript:pesquisarIndice(\'^I\')">I</a></li>')
                                .append('<li><a class="busca-indice" href="javascript:pesquisarIndice(\'^J\')">J</a></li>')
                                .append('<li><a class="busca-indice" href="javascript:pesquisarIndice(\'^K\')">K</a></li>')
                                .append('<li><a class="busca-indice" href="javascript:pesquisarIndice(\'^L\')">L</a></li>')
                                .append('<li><a class="busca-indice" href="javascript:pesquisarIndice(\'^M\')">M</a></li>')
                                .append('<li><a class="busca-indice" href="javascript:pesquisarIndice(\'^N\')">N</a></li>')
                                .append('<li><a class="busca-indice" href="javascript:pesquisarIndice(\'^O\')">O</a></li>')
                                .append('<li><a class="busca-indice" href="javascript:pesquisarIndice(\'^P\')">P</a></li>')
                                .append('<li><a class="busca-indice" href="javascript:pesquisarIndice(\'^Q\')">Q</a></li>')
                                .append('<li><a class="busca-indice" href="javascript:pesquisarIndice(\'^R\')">R</a></li>')
                                .append('<li><a class="busca-indice" href="javascript:pesquisarIndice(\'^S\')">S</a></li>')
                                .append('<li><a class="busca-indice" href="javascript:pesquisarIndice(\'^T\')">T</a></li>')
                                .append('<li><a class="busca-indice" href="javascript:pesquisarIndice(\'^U\')">U</a></li>')
                                .append('<li><a class="busca-indice" href="javascript:pesquisarIndice(\'^V\')">V</a></li>')
                                .append('<li><a class="busca-indice" href="javascript:pesquisarIndice(\'^W\')">W</a></li>')
                                .append('<li><a class="busca-indice" href="javascript:pesquisarIndice(\'^X\')">X</a></li>')
                                .append('<li><a class="busca-indice" href="javascript:pesquisarIndice(\'^Y\')">Y</a></li>')
                                .append('<li><a class="busca-indice" href="javascript:pesquisarIndice(\'^Z\')">Z</a></li>')
                                .append('<li><a class="busca-indice" href="javascript:pesquisarIndice(\'\')"><i class="icon-remove"></i></a></li>')
                                .append('</ul>')
                                .change(function() {
                                    var keyword = $(this).val();
                                    keyword = removeAcentos(keyword);
                ...
                this.notfound = $('<p></p>').addClass('mapplic-not-found').text('NÃ£o encontrado. Tente uma nova pesquisa.').appendTo(listContainer);
            ...
            this.addLocation = function(data) {
                ...
                $('<h4></h4>').text(data.title).appendTo(link).addClass('destaque-' + data.VitrineDestaque);
            ...
            this.search = function(keyword) {
                ...
                $('.mapplic-list li', self.el).each(function() {
                    ...
                    if (valor.search(new RegExp(keyword, "i")) < 0) {
        ...
        // FRT - 2016/03/26 - funcao para remover acentos
        var removeAcentos = (function() {
            var translate_re = /[Ã©Ã¡Å±Å‘ÃºÃ¶Ã¼Ã³Ã­Ã‰ÃÅ°PÅÃšÃ–ÃœÃ“Ã]/g;
            var translate = {
                "Ã©": "e",
                "Ã¡": "a",
                "Å±": "u",
                    ...
                    $.each(value.locations, function(index, value) {
                        ...
                        if (value.pin != 'hidden') {
                            if (self.o.markers) {
                                ...
                                if (value.fill) {
                                    pin.css('background-color', value.fill);
                                    pin.addClass('destaque');
                                    //  $('<a></a>').attr('href', target).addClass(value.fill);
                                }
        ...
        var addControls = function() {
            ...
            self.map.on('touchstart', function(e) {
                if (e.originalEvent.touches.length > 1) hammer.get('pinch').set({
                    enable: true
                });
            });
